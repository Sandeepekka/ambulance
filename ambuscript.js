...
function displayAmbulanceDetails(distance, duration, price) {
    ...
    ambulanceDetails.innerHTML = `
        ...
        <div class="ambulance-card">
            <h3>Ambulance 2</h3>
            <p>Driver: Amlan Tudu</p>
            <p>Vehicle: OD-14B-0987</p>
            <button onclick="callDriver('0987654321')">Call Now</button>
            <button onclick="bookDriver('0987654321')">Book Now</button>
        </div>
         
         <div class="ambulance-card">
            <h3>Ambulance 4</h3>
            <p>Driver: Aditya Sonu</p>
